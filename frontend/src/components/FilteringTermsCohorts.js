...
function FilteringTermsCohorts(props) {
    ...
    const remove = tag => {
        ...
        if (props.placeholder.includes(`,${tag.value}`)) {
            ...
            props.setPlaceholder(props.placeholder.replace(tag.value, ""))
            props.setPlaceholder('Search for any cohort')
        }
    ...
    const handleCheck = (e) => {
        ...
        if (props.placeholder.includes(e.target.value)) {
            ...
            if ((e.target.value != props.placeholder) && (props.placeholder != 'Search for any cohort')) {
                let stringQuery = `${props.placeholder},` + e.target.value
                stringQuery = stringQuery.replace('Search for any cohort', '')
                props.setPlaceholder(stringQuery)
            } else {
...
export default FilteringTermsCohorts