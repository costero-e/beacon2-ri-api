...
routes = [
    ...
    web.get('/api/analyses/filtering_terms', generic_handler(db_fn=analyses.get_filtering_terms_of_analyse)),
    ...
    web.get('/api/biosamples/filtering_terms', generic_handler(db_fn=biosamples.get_filtering_terms_of_biosample)),
    ...
    web.get('/api/cohorts/filtering_terms', generic_handler(db_fn=cohorts.get_filtering_terms_of_cohort)),
    ...
    web.get('/api/datasets/filtering_terms', generic_handler(db_fn=datasets.get_filtering_terms_of_dataset)),
    ...
    web.get('/api/g_variants/filtering_terms', generic_handler(db_fn=g_variants.get_filtering_terms_of_genomicvariation)),
    ...
    web.get('/api/individuals/filtering_terms', generic_handler(db_fn=individuals.get_filtering_terms_of_individual)),
    ...
    web.get('/api/runs/filtering_terms', generic_handler(db_fn=runs.get_filtering_terms_of_run)),
    ...
    web.post('/api/biosamples/filtering_terms', generic_handler(db_fn=biosamples.get_filtering_terms_of_biosample)),
    ...
    web.post('/api/cohorts/filtering_terms', generic_handler(db_fn=cohorts.get_filtering_terms_of_cohort)),
    ...
    web.post('/api/datasets/filtering_terms', generic_handler(db_fn=datasets.get_filtering_terms_of_dataset)),
    ...
    web.post('/api/g_variants/filtering_terms', generic_handler(db_fn=g_variants.get_filtering_terms_of_genomicvariation)),
    ...
    web.post('/api/individuals/filtering_terms', generic_handler(db_fn=individuals.get_filtering_terms_of_individual)),
    ...
    web.post('/api/runs/filtering_terms', generic_handler(db_fn=runs.get_filtering_terms_of_run)),
