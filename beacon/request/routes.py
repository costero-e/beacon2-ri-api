...
routes = [
    ...
    web.get('/api/filtering_terms', generic_handler(db_fn=filtering_terms.get_filtering_terms)),
    ...
    web.get('/api/filtering_terms/analyses', generic_handler(db_fn=analyses.get_filtering_terms_of_analyse)),
    ...
    web.get('/api/filtering_terms/biosamples', generic_handler(db_fn=biosamples.get_filtering_terms_of_biosample)),
    ...
    web.get('/api/filtering_terms/cohorts', generic_handler(db_fn=cohorts.get_filtering_terms_of_cohort)),
    ...
    web.get('/api/filtering_terms/datasets', generic_handler(db_fn=datasets.get_filtering_terms_of_dataset)),
    ...
    web.get('/api/filtering_terms/g_variants', generic_handler(db_fn=g_variants.get_filtering_terms_of_genomicvariation)),
    ...
    web.get('/api/filtering_terms/individuals', generic_handler(db_fn=individuals.get_filtering_terms_of_individual)),
    ...
    web.get('/api/filtering_terms/runs', generic_handler(db_fn=runs.get_filtering_terms_of_run)),
    ...
    web.post('/api/filtering_terms/analyses', generic_handler(db_fn=analyses.get_filtering_terms_of_analyse)),
    ...
    web.post('/api/filtering_terms/biosamples', generic_handler(db_fn=biosamples.get_filtering_terms_of_biosample)),
    ...
    web.post('/api/filtering_terms/cohorts', generic_handler(db_fn=cohorts.get_filtering_terms_of_cohort)),
    ...
    web.post('/api/filtering_terms/datasets', generic_handler(db_fn=datasets.get_filtering_terms_of_dataset)),
    ...
    web.post('/api/filtering_terms/g_variants', generic_handler(db_fn=g_variants.get_filtering_terms_of_genomicvariation)),
    ...
    web.post('/api/filtering_terms/individuals', generic_handler(db_fn=individuals.get_filtering_terms_of_individual)),
    ...
    web.post('/api/filtering_terms/runs', generic_handler(db_fn=runs.get_filtering_terms_of_run)),
]
