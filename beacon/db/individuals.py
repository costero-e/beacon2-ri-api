...
def get_individuals(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
...
def get_individual_with_id(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
    collection = 'individuals'
    query = apply_request_parameters({}, qparams)
    query = apply_filters(query, qparams.query.filters, collection, allowed_ids)
...
def get_variants_of_individual(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
    collection = 'individuals'
...
def get_biosamples_of_individual(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
    collection = 'individuals'
...
def get_filtering_terms_of_individual(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
...
def get_runs_of_individual(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
    collection = 'individuals'
    query = {"individualId": entry_id}
    query = apply_request_parameters(query, qparams)
    query = apply_filters(query, qparams.query.filters, collection, allowed_ids)
...
def get_analyses_of_individual(entry_id: Optional[str], qparams: RequestParams, allowed_ids: list):
    collection = 'individuals'
    query = {"individualId": entry_id}
    query = apply_request_parameters(query, qparams)
    query = apply_filters(query, qparams.query.filters, collection, allowed_ids)
